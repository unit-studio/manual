...
以下,源自 [vue-cli 官网指南](https://cli.vuejs.org/zh/guide/)

在 <a href="assets/vue_app.zip" target="_blank">vue_app.zip</a> 保留了一份 `@vue/cli 4.1.2` 版本构建的项目压缩包.
...
![](assets/markdown-img-paste-2020010710434667.png)

这个默认的设置非常适合快速创建一个新项目的原型，而手动设置则提供了更多的选项，它们是面向生产的项目更加需要的。

![](assets/markdown-img-paste-20200107104352623.png)
...
![](assets/markdown-img-paste-20200107104404218.png)
